...
export async function connectViewBridge(
  ...
  bridge.onlistresources = async (_params, extra) =>
    rpcValue<ListResourcesResult>(connection, 'resources/list', null, extra.signal)
  bridge.onreadresource = async (params, extra) =>
    rpcValue<ReadResourceResult>(connection, 'resources/read', { uri: params.uri }, extra.signal)
